...
function prepareAIContext(message, context, mood) {
  let aiContext = `You are ChittSaathi AI Assistant, a supportive mental health companion specifically designed for students. Your role is to provide empathetic, non-judgmental, and helpful support.
